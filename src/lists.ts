...
export default class DemoList extends BasicList {
  ...
  public readonly description = 'CocList for coc-thrift-syntax-support';
  ...
  public async loadItems(context: ListContext): Promise<ListItem[]> {
    return [
      {
        label: 'coc-thrift-syntax-support list item 1',
        data: { name: 'list item 1' },
      },
      {
        label: 'coc-thrift-syntax-support list item 2',
